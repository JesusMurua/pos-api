...
public class UnitOfWork : IUnitOfWork
{
    ...
    private ISubscriptionAddOnRepository? _subscriptionAddOns;
    ...
    public ISubscriptionAddOnRepository SubscriptionAddOns =>
        _subscriptionAddOns ??= new SubscriptionAddOnRepository(_context);
